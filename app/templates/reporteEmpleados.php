...
<div class="container">
    <div class="form-card mx-auto col-md-6">
        ...
        <p align="center">Genere reportes personalizados de empleados según su fecha de registro y el rol (puesto).</p>
        ...
        <div class="d-flex justify-content-between">
                <div>
                    <button type="submit" name="generarSinParametros" class="btn btn-primary me-2"><a href="../convertirpdf/reporteEmpleados1.php"style="color: white;">Generar sin parámetros</a></button>
                </div>
            </div>
    </div>
</div>
